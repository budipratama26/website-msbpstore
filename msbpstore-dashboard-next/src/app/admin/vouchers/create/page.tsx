        ...
        <div className="card p-6 sm:p-8 space-y-6" style={{maxWidth:"720px",margin:"0 auto"}}>
            <div style={{display:"flex",flexWrap:"wrap",alignItems:"center",gap:"16px",borderBottom:"1px solid var(--bg-border)",paddingBottom:"16px"}}>
                ...
                <div>
                    ...
                    <p style={{color:"var(--text-muted)",fontSize:"13px",fontWeight:500,marginTop:"4px"}}>Buat kupon diskon untuk pelanggan Anda.</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} style={{display:"flex",flexDirection:"column",gap:"24px"}}>
                <div style={{display:"flex",flexDirection:"column",gap:"24px"}}>
                            ...
                            {form.discountType === "PERCENTAGE" && (
                                <div style={{display:"flex",flexDirection:"column",gap:"6px"}}>
                                    ...
                                    <input
                                        ...
                                        className="form-input"
                                    />
                                    <p className="text-[10px] text-[var(--text-muted)] font-medium">Batas potongan maksimal agar margin aman.</p>
                                </div>
                            )}
                            <div style={{display:"flex",flexDirection:"column",gap:"6px"}}>
                                ...
                                <input
                                    ...
                                    className="form-input"
                                />
                                <p className="text-[10px] text-[var(--text-muted)] font-medium">Kosongkan jika tidak ada minimum.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div style={{display:"flex",flexDirection:"column",gap:"6px"}}>
                                ...
                                <input
                                    ...
                                    className="form-input"
                                />
                                <p className="text-[10px] text-[var(--text-muted)] font-medium">Berapa kali satu user boleh pakai voucher ini.</p>
                            </div>
                            <div style={{display:"flex",flexDirection:"column",gap:"6px"}}>
                                ...
                                <input
                                    ...
                                    className="form-input"
                                />
                                <p className="text-[10px] text-[var(--text-muted)] font-medium">Kosongkan jika tidak ada batas waktu.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{display:"flex",alignItems:"center",gap:"14px",background:"var(--bg-elevated)",borderRadius:"var(--radius-xl)",padding:"14px",border:"1px solid var(--bg-border)"}}>
                        ...
                        >
                            <div style={{position:"absolute",top:"4px",width:"16px",height:"16px",borderRadius:"50%",background:"#fff",boxShadow:"0 1px 3px rgba(0,0,0,0.3)",transition:"left 200ms ease",left:form.active?"22px":"2px"}} />
                        </button>
                        <div>
                ...
                <div className="pt-6 mt-6 border-t border-[var(--bg-border)] flex items-center justify-end gap-4">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="bg-[var(--accent-primary)] hover:bg-emerald-700 text-white px-8 py-3 rounded-xl flex items-center gap-2 text-[11px] font-black uppercase tracking-[0.2em] shadow-lg shadow-emerald-500/20 transition-all active:scale-95 disabled:opacity-50"
                    >
