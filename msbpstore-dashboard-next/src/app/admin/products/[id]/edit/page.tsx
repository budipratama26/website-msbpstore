...
export default function EditProductPage() {
    ...
    if (fetching) {
        return <FormSkeleton title="Edit Produk" />;
    }
        ...
        <div className="card p-6 sm:p-8 space-y-6" style={{maxWidth:"720px",margin:"0 auto"}}>
            <div style={{display:"flex",flexWrap:"wrap",alignItems:"center",gap:"16px",borderBottom:"1px solid var(--bg-border)",paddingBottom:"16px"}}>
                ...
                <div>
                    ...
                    <p style={{color:"var(--text-muted)",fontSize:"13px",fontWeight:500,marginTop:"4px"}}>Perbarui informasi produk <span className="text-[var(--accent-primary)] font-bold font-mono">#{productId}</span>.</p>
                </div>
            </div>
                ...
                <div style={{display:"flex",flexDirection:"column",gap:"24px"}}>
                    ...
                    <div style={{display:"flex",alignItems:"center",gap:"14px",background:"var(--bg-elevated)",borderRadius:"var(--radius-xl)",padding:"14px",border:"1px solid var(--bg-border)"}}>
                        ...
                        <div>
                            ...
                            <p style={{fontSize:"11px",color:"var(--text-muted)",fontWeight:500,marginTop:"2px"}}>Atur keterlihatan produk ke publik.</p>
                        </div>
                    </div>
                </div>
