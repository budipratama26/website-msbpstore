 ...
 * @param type 'auth' (50/min), 'checkout' (100/min), 'gen' (2000/min), or 'admin' (5000/min)
 * @returns { allowed: boolean, count: number }
 */
export async function checkRateLimit(identifier: string, type: 'auth' | 'checkout' | 'gen' | 'admin' = 'gen') {
