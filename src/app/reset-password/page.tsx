...
function ResetPasswordForm() {
    ...
    if (isSuccess) {
        return (
            <div style={{ textAlign: "center", padding: "32px 0 16px" }}>
                <div style={{ width: "52px", height: "52px", background: "var(--success-muted)", border: "1px solid rgba(16,185,129,0.4)", borderRadius: "var(--radius-lg)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 20px" }}>
                ...
                <div style={{ height: "3px", background: "var(--bg-elevated)", borderRadius: "var(--radius-full)", overflow: "hidden" }}>
                    <div style={{ height: "100%", background: "var(--accent-primary)", animation: "progress 3s linear forwards", transformOrigin: "left" }} />
                </div>
    ...
    if (!isValidToken) {
        return (
            <div style={{ textAlign: "center", padding: "32px 0 16px" }}>
                <div style={{ width: "52px", height: "52px", background: "var(--error-muted)", border: "1px solid rgba(239,68,68,0.4)", borderRadius: "var(--radius-lg)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 20px" }}>
                ...
                <p style={{ fontSize: "13px", color: "var(--text-muted)", lineHeight: 1.65, marginBottom: "20px" }}>
                    Link reset password ini sudah kadaluarsa atau sudah pernah digunakan sebelumnya. Silakan ajukan reset password kembali.
                </p>
    ...
    return (
        <div>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginBottom: "24px", marginTop: "32px" }}>
                <div style={{ width: "48px", height: "48px", background: "var(--accent-muted)", border: "1px solid var(--accent-border)", borderRadius: "var(--radius-lg)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "16px" }}>
    ...
    return (
        <div style={{ minHeight: "calc(100vh - var(--header-height, 56px))", background: "var(--bg-base)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 16px" }}>
            <div style={{ width: "100%", maxWidth: "420px" }}>
                <div className="card" style={{ padding: "24px 28px 32px", position: "relative" }}>
